...
export function LoginScreen() {
  const { signInWithGoogle, loading, continueAsGuest } =
    useAuth();

  return (
    <div className="flex flex-col h-screen bg-[#1a1a1a] max-w-md mx-auto relative overflow-hidden">
      {/* Top area with logo */}
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        >
          ...
          <p className="text-[#999] text-[15px] leading-relaxed max-w-[280px] mx-auto">
            ...
            collections, and settings when you reinstall or
            switch devices
          </p>
        </motion.div>
      </div>
